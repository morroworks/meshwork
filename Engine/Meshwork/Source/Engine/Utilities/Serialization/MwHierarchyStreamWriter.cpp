...
#include "MwHierarchyStreamWriter.h"


MwHierarchyStreamWriter::MwHierarchyStreamWriter(MwBaseStream &stream)
{
    this->stream = &stream;
}


MwHierarchyStreamWriter::~MwHierarchyStreamWriter(void)
{
}

void MwHierarchyStreamWriter::BeginChunk(unsigned int chunkId)
{
...
void MwHierarchyStreamWriter::EndChunk()
{
